...
import com.foo.dao.mapper.EntityRowMapper;
import com.foo.model.Entity;
import com.foo.util.Pair;
...
public class EntityDao extends BaseDao {
  ...
  public int count(String modelName, String column, boolean distinct, String columnName, Object columnValue) {
    StringBuilder sb = new StringBuilder("SELECT COUNT(");
    if (distinct) {
      sb.append("DISTINCT ");
    }
    sb.append(column).append(" ) FROM ").append(modelName);
    sb.append(" WHERE ").append(columnName).append(" = ?");

    Integer count = jdbcTemplate.queryForObject(sb.toString(), Integer.class, new Object[] { columnValue });
    return count == null ? 0 : count;
  }
  ...
  public int count(String modelName, String column, String columnName, Object columnValue) {
    return count(modelName, column, true, columnName, columnValue);
  }

  public int countByOffset(String modelName, Map<Pair<String, String>, Object> offsets) {
    return countByOffset(modelName, "id", true, Collections.<String, Object>emptyMap(), offsets);
  }

  public int countByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets) {
    return countByOffset(modelName, "id", true, condition, offsets);
  }

  public int countByOffset(String modelName, String column, boolean distinct, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets) {
    ...
    sb.append(column).append(") FROM ").append(modelName).append(" WHERE ");
    Object[] params = new Object[condition.size() + offsets.size()];
  ...
  public int countByOffset(String modelName, String column, Map<Pair<String, String>, Object> offsets) {
    return countByOffset(modelName, column, true, Collections.<String, Object>emptyMap(), offsets);
  }
  ...
  public <T> List<T> findByOffset(String modelName, long offset, int pageSize, RowMapper<T> rowMapper) {
    return findByOffset(modelName, Collections.<String, Object>emptyMap(), ORDER_BY_ID, ORDER_OPTION_DESC, offset, pageSize, rowMapper);
  }
  ...
  public <T> List<T> findByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets, int pageSize, RowMapper<T> rowMapper) {
    return findByOffset(modelName, condition, offsets, BaseDao.ORDER_BY_ID, BaseDao.ORDER_OPTION_ASC, 1, pageSize, rowMapper);
  }
  ...
  public <T> List<T> findByOffset(String modelName, Map<String, Object> condition, Map<Pair<String, String>, Object> offsets, String orderBy, String orderOption, int pageSize,
      RowMapper<T> rowMapper) {
    return findByOffset(modelName, condition, offsets, orderBy, orderOption, 1, pageSize, rowMapper);
  }
  ...
  public <T> List<T> findByOffset(String modelName, String orderBy, long offset, int pageSize, RowMapper<T> rowMapper) {
    return findByOffset(modelName, Collections.<String, Object>emptyMap(), orderBy, ORDER_OPTION_DESC, offset, pageSize, rowMapper);
  }

  public <T> List<T> findByOffset(String modelName, String orderBy, String orderOption, long offset, int pageSize, RowMapper<T> rowMapper) {
    return findByOffset(modelName, Collections.<String, Object>emptyMap(), orderBy, orderOption, offset, pageSize, rowMapper);
  }
  ...
  public Entity findOne(String modelName, Map<String, Object> condition, String orderBy, String orderOption) {
    return findOne(modelName, condition, EntityRowMapper.getInstance(), orderBy, orderOption);
  }
  ...
  public <T> T findOne(String modelName, String columnName, Object columnValue, RowMapper<T> rowMapper) {
    return findOne(modelName, columnName, columnValue, rowMapper, BaseDao.ORDER_BY_ID, BaseDao.ORDER_OPTION_DESC);
  }

  public <T> T findOne(String modelName, String columnName, Object columnValue, RowMapper<T> rowMapper, String orderBy, String orderOption) {
    Map<String, Object> condition = new HashMap<String, Object>();
    condition.put(columnName, columnValue);

    return findOne(modelName, condition, rowMapper, orderBy, orderOption);
  }

  public Entity findOne(String modelName, String columnName, Object columnValue, String orderBy, String orderOption) {
    return findOne(modelName, columnName, columnValue, EntityRowMapper.getInstance(), orderBy, orderOption);
  }
  ...
  public List<Entity> get(String modelName, int pageNumber, int pageSize) {
    return get(modelName, pageNumber, pageSize, EntityRowMapper.getInstance());
  }
